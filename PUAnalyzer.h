...
// used to generate this class and read the Tree.
   if (tree == 0) {					      
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("MinBias_D13_PU2005stubsChi2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("MinBias_D13_PU2005stubsChi2.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("MinBias_D13_PU2005stubsChi2.root:/L1TrackNtuple");
