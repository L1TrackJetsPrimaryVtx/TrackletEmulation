...
if GEOMETRY == "D13":
    ...
    'file:/fdata/hepx/store/user/rish/CMSSW_9_2_0/src/TTBarNoPU/TTBar_example_TkOnly_%s.root' %sys.argv[2],
    #'file:/fdata/hepx/store/user/rish/CMSSW_9_2_0/src/PGun_example_TkOnly_%s.root' %sys.argv[2],
    #'file:/fdata/hepx/store/user/rish/CMSSW_9_2_0/src/PtHat30/QCDPt30_example_TkOnly_%s.root' %sys.argv[2],
    #'file:/fdata/hepx/store/user/rish/CMSSW_9_2_0/src/L1Trigger/TrackFindingTracklet/test/TTBarPU200/%s' %sys.argv[2],
    #'file:/fdata/hepx/store/user/rish/CMSSW_9_2_0/src/L1Trigger/TrackFindingTracklet/test/MinBiasSamples/%s' %sys.argv[2],
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string('TTBar_'+GEOMETRY+'_PU200_%d.root' %(int(sys.argv[3]))), closeFileFast = cms.untracked.bool(True))
