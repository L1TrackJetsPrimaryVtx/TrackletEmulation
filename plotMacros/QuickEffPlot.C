...
setTDRStyle();
TFile*fin=new TFile("FastJetEffTTBarPU200.root", "READ");
...
TEfficiency*EffRecoPt10=(TEfficiency*)fin->Get("RecoTruthPt");
    ...
    //    TFile*fin2=new TFile("em_outTTBarPU200_16z.txt.root", "READ");
    ...
    TFile*fin3=new TFile("em_outTTBarPU200_64z.txt.root", "READ");
    TEfficiency*EffRecoL1L2Pt=(TEfficiency*)fin3->Get("MatchingEfficiencyPt");
    TEfficiency*EffRecoL1L2Eta=(TEfficiency*)fin3->Get("MatchingEfficiencyEta");
    TEfficiency*EffNtracks1RecoL1L2Pt=(TEfficiency*)fin3->Get("MatchingEfficiencyNtracksPt");
    TEfficiency*EffNtracks1RecoL1L2Eta=(TEfficiency*)fin3->Get("MatchingEfficiencyNtracksEta");
    fin->cd();
...
EffGenChgE->SetTitle("Track Jet Finding Efficiency; Charged Energy Fraction; Efficiency for Gen Jets (pT>30GeV)");
    ...
    leg->AddEntry(EffRecoL1L2Pt, "L1L2 Tracklet Jets pT>10 ", "L");
...
TCanvas*c3=new TCanvas("c3", "", 800, 800);
    ...
    graph->GetYaxis()->SetTitleSize(0.05);
    graph->GetYaxis()->SetRangeUser(0.2, 1.05);
    graph->Draw("APE");
    EffGenEta->Draw("same");
