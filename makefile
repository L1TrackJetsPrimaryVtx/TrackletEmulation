...
all:
	g++  `root-config --cflags --glibs` -L $(ROOTSYS)/lib -I/$(ROOTSYS)/include -I$(CMSSW_BASE)/src -I$(CMSSW_BASE)/src/cxxopts/include/ tracklet_em_L1L2.cpp L1_cluster.cpp L2_cluster.cpp 
#tracklet_em_L1L2:
